			...
			BX.adjust(this.popupMessengerBodyLiveChatForm, {children: [
				BX.create("div", { props : { className : "bx-messenger-livechat-form-wrap" }, children: [
					...
					BX.create("div", { props : { className : "bx-messenger-livechat-form-input-wrap" }, children: [
						BX.create("input", { attrs: {placeholder: BX.message('IMOL_LIVECHAT_FORM_INPUT_EMAIL_NEW'), name: 'email'}, props : { className : "bx-messenger-livechat-form-input bx-messenger-livechat-form-input-email" }, events: {keydown: BX.delegate(function(event){
							this.tooltipClose();
							...
							if (event.keyCode == 13)
							{
								...
								if (!BX.proxy_context.value || !BX.proxy_context.value.match(/^(.*)@(.*)\.[a-zA-Z]{2,}$/))
								{
									setTimeout(BX.proxy(function(){
										...
										this.tooltip(item, BX.message('IMOL_LIVECHAT_FORM_INPUT_EMAIL_ERROR_NEW'), {offsetTop: 10, offsetLeft: 12});
									}, this), 500);
								}
							}
		...
		if (!stage || stage == 1)
		{
			...
			BX.adjust(this.popupMessengerBodyLiveChatForm, {children: [
				BX.create("div", { props : { className : "bx-messenger-livechat-form-wrap" }, children: [
					...
					BX.create("div", { props : { className : "bx-messenger-livechat-form-input-wrap" }, children: [
						BX.create("input", { attrs: {placeholder: BX.message('IMOL_LIVECHAT_FORM_INPUT_NAME_NEW'), name: 'name'}, props : { className : "bx-messenger-livechat-form-input bx-messenger-livechat-form-input-name" }, events: {keydown: BX.delegate(function(event){
							if (event.keyCode == 9 || event.keyCode == 13)
							{
	...
	else if (type == 'history')
	{
		...
		BX.adjust(this.popupMessengerBodyLiveChatForm, {children: [
			BX.create("div", { props : { className : "bx-messenger-livechat-form-wrap" }, children: [
				...
				BX.create("div", { props : { className : "bx-messenger-livechat-form-text-wrap" }, children: [
					BX.create("div", { props : { className : "bx-messenger-livechat-form-text" }, html: BX.message('IMOL_LIVECHAT_FORM_TITLE_HISTORY_NEW')}),
				...
				BX.create("div", { props : { className : "bx-messenger-livechat-form-input-wrap" }, children: [
					BX.create("input", { attrs: {placeholder: BX.message('IMOL_LIVECHAT_FORM_INPUT_EMAIL_NEW'), name: 'email', value: this.BXIM.userEmail}, props : { className : "bx-messenger-livechat-form-input bx-messenger-livechat-form-input-email" }, events: {keydown: BX.delegate(function(event){
						this.tooltipClose();
						...
						if (event.keyCode == 9 || event.keyCode == 13)
						{
							if (!BX.proxy_context.value || !BX.proxy_context.value.match(/^(.*)@(.*)\.[a-zA-Z]{2,}$/))
							{
								this.tooltip(BX.proxy_context, BX.message('IMOL_LIVECHAT_FORM_INPUT_EMAIL_ERROR_2_NEW'), {offsetTop: 10, offsetLeft: 12});
								BX.proxy_context.parentNode.nextSibling.firstChild.nextSibling.focus();
								return BX.PreventDefault(event);
							}
