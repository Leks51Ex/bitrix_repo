...
(function (exports,main_core) {
	...
	var nodeEnum = function () {
	  var nodeEnum = function nodeEnum(select, eventNode, container) {
	  ...
	  nodeEnum.prototype = {
	    init: function init(select, eventNode, container) {
	...
	BX.Mobile.Field.Enum.prototype = {
	  ...
	  bindElement: function bindElement(node) {
	    ...
	    if (BX(node)) {
	      ...
	      // );
	      result = new nodeEnum(node, BX("".concat(node.id, "_select")), BX("".concat(node.id, "_select")) // BX(node.id + '_select'),
