...
$MESS["SC_CRM_STORE_CONTAINER_CONTENT_2_MSGVER_1"] = "CRM jest teraz w pełni funkcjonalną platformą sprzedaży online ze współczesnymi metodami płatności, pokwitowaniami i dostawami. Prosty proces płatności zapewnia, że klient zrealizuje zamówienie.<br>Włącz moduł Płatności CRM i obserwuj wzrost konwersji!";
$MESS["SC_CRM_STORE_CONTAINER_GO_TO_DEAL"] = "Aby rozpocząć sprzedaż, przejdź do deala";
...
$MESS["SC_CRM_STORE_CONTAINER_SUB_TITLE_2_MSGVER_1"] = "Obejrzyj wideo, aby dowiedzieć się <br>w jaki sposób moduł Płatności CRM zwiększa sprzedaż";
$MESS["SC_CRM_STORE_CONTAINER_TITLE"] = "Nowa era sprzedaży online";
$MESS["SC_CRM_STORE_TITLE_2"] = "CRM.Płatność";
$MESS["SC_CRM_STORE_TITLE_2_MSGVER_1"] = "Płatności CRM";
