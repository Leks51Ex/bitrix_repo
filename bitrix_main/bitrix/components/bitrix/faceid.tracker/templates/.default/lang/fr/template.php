...
<li class=\"tracker-agreement-popup-list-item\">
Bitrix24 n'est en aucun cas responsable du Service et ne formule aucune prétention ou garantie quant à l'exactitude ou la disponibilité du Service, et ne fournit aucune assistance technique ou consultation pour le Service.
</li>
</ol>
<div class=\"tracker-agreement-popup-description\">
En acceptant l'accord de service, vous convenez et confirmez que Bitrix24 ne recueille ou ne traite aucune donnée que vous téléchargez sur le Service et que Bitrix24 n'a aucune connaissance de la façon dont vous recueillez les données.
</div>
</div>";
...
$MESS["FACEID_TRACKER_CMP_DESCR"] = "Le Face Tracker va enregistrer et compter les visiteurs dans votre magasin ou bureau: total de visiteurs par jour; nouveaux visiteurs; visiteurs existants; visiteurs déjà présents dans votre CRM.";
$MESS["FACEID_TRACKER_CMP_DESCR_P1"] = "Recherche instantanée par photo parmi les personnes enregistrées dans votre CRM.";
$MESS["FACEID_TRACKER_CMP_DESCR_P1_NEW"] = "Le Face Tracker utilise la technologie de reconnaissance faciale pour identifier vos clients.
...
$MESS["FACEID_TRACKER_CMP_DESCR_P2_NEW"] = "Le Face Tracker peut identifier un profil social VK par photo prise et ajoutera le profil à votre CRM.";
...
<span class=\"faceid-tracker-first-visit-desc-item\">Prenez une première photo de votre client et le Face Tracker pourra \"s'en rappeler\".
Lors de la prochaine visite de cette personne, le système l'identifiera comme visiteur existant. </span>
</div>
</div>
<div class=\"faceid-tracker-first-visit-desc-inner\">
<div class=\"faceid-tracker-first-visit-desc-title\">Comment utiliser le Face Tracker comme compteur de fréquentation</div>
<div class=\"faceid-tracker-first-visit-desc-block\">
...
<span class=\"faceid-tracker-first-visit-desc-item\">Lancez le Face Tracker sur cet ordinateur</span>
