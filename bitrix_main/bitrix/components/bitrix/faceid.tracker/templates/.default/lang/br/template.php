...
$MESS["FACEID_TRACKER_CMP_AGR_TEXT"] = "<div class=\"tracker-agreement-popup-content\">
   <ol class=\"tracker-agreement-popup-list\">
    ...
    <li class=\"tracker-agreement-popup-list-item\">
     A Bitrix24 não é de forma alguma responsável pelo Serviço e não apresenta reclamações ou garantias no que diz respeito à exatidão ou à disponibilidade do Serviço, nem fornece qualquer suporte técnico ou consultas sobre o Serviço. 
    </li>
   </ol>
   <div class=\"tracker-agreement-popup-description\">
    Ao aceitar o acordo de Serviço, você concorda e confirma que a Bitrix24 não coleta ou processa quaisquer dados carregados por você no Serviço e que a Bitrix24 não sabe e não deve saber as circunstâncias nas quais estes dados foram coletados. 
   </div>
  </div>";
...
$MESS["FACEID_TRACKER_CMP_AUTO_LEAD"] = "criar um Lead";
...
$MESS["FACEID_TRACKER_CMP_DESCR"] = "Face Tracker irá registrar e contar visitantes na sua loja ou escritório: total de visitantes no dia de hoje; novos visitantes; visitantes que retornaram; visitantes que já existem no seu CRM.";
$MESS["FACEID_TRACKER_CMP_DESCR_P1"] = "Pesquisa imediata por foto entre pessoas registradas no seu CRM.";
$MESS["FACEID_TRACKER_CMP_DESCR_P1_NEW"] = "Face Tracker utiliza tecnologia de reconhecimento facial para identificar seus clientes. Ele pode contar todos os visitantes da sua loja ou do seu escritório, contar quantos visitantes são novos, quantos estão retornando e quantos já estão no seu CRM.";
$MESS["FACEID_TRACKER_CMP_DESCR_P2"] = "O Bitrix24 irá encontrar um perfil social por foto e adicionar o perfil ao seu CRM.";
$MESS["FACEID_TRACKER_CMP_DESCR_P2_NEW"] = "Face Tracker pode identificar o perfil social VK pela foto tirada e adicionar o perfil ao seu CRM.";
...
$MESS["FACEID_TRACKER_CMP_JS_SAVE_CRM_DONE"] = "O Lead foi salvo";
