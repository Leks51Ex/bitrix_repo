...
$MESS["CRM_LEAD_LIST_BATCH_CONVERSION_AUTOCREATION_DISABLED_MSGVER_1"] = "La conversion de groupe nécessite l'activation de l'option \"Créer automatiquement des contacts, sociétés, transactions, factures et devis\" dans les paramètres du CRM (Paramètres > Autres paramètres > Général > Entités générées automatiquement).";
