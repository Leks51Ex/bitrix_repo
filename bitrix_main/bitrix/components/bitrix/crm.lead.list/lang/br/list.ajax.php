...
$MESS["CRM_LEAD_LIST_BATCH_CONVERSION_AUTOCREATION_DISABLED_MSGVER_1"] = "A conversão de grupo exige que a opção \"Criar automaticamente contatos, empresas, Negócios, faturas e orçamentos\" seja ativada na página de configurações do CRM (Configurações> Outras configurações> Geral> Entidades geradas automaticamente).";
