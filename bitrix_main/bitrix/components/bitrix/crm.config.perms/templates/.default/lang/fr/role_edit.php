...
$MESS["CRM_CONFIG_PERMS_REBUILD_COMPANY_ATTR_DLG_TITLE"] = "Mettre à jour les attributs d'accès de l'entreprise";
...
$MESS["CRM_CONFIG_PERMS_REBUILD_DEAL_ATTRS"] = "Les droits d'accès mis à jour exigent que vous <a id='#ID#' href='#URL#'>mettiez à jour</a> les attributs d'accès pour les transactions précédemment créés.";
...
$MESS["CRM_CONFIG_PERMS_REBUILD_LEAD_ATTRS"] = "Les autorisations d'accès aux prospects mises à jour exigent que vous<a id='#ID#' href='#URL#'>mettez à jour</a> les attributs d'accès pour les prospects créés précédemment.";
...
$MESS["CRM_CONFIG_PERMS_REBUILD_LEAD_ATTR_DLG_TITLE"] = "Mettre à jour les attributs d'accès aux prospects";
...
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTRS_MSGVER_1"] = "Les autorisations d'accès mises à jour de cotation exigent que vous <a id='#ID#' href='#URL#'>mis à jour</a> attributs d'accès pour les devis créés précédemment.";
...
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTR_DLG_SUMMARY_MSGVER_1"] = "Attributs d'accès vont maintenant être reconstruits pour toutes les citations. Cette procédure peut prendre un certain temps.";
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTR_DLG_TITLE"] = "Attributs d'accès Mise à jour Quote";
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTR_DLG_TITLE_MSGVER_1"] = "Attributs d'accès Mise à jour Quote";
