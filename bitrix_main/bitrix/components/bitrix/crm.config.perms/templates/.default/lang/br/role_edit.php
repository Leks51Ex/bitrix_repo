...
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTRS_MSGVER_1"] = "As permissões de acesso atualizadas de cotas exigem que você <a id=\"#ID#\"href=\"#URL#\">atualize</a>os atributos de acesso para as cotas criadas anteriormente.";
...
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTR_DLG_SUMMARY_MSGVER_1"] = "Os atributos de acesso não serão refeitos para todas as cotas. Este procedimento pode demorar algum tempo.";
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTR_DLG_TITLE"] = "Atualizar os Atributos de Acesso de Cotas";
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTR_DLG_TITLE_MSGVER_1"] = "Atualizar os Atributos de Acesso de Cotas";
