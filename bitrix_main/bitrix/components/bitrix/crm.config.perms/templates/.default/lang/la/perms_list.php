...
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTRS_MSGVER_1"] = "Las actualizaciones de permisos de acceso de las cotizaciones requieren que usted <a id=\"#ID#\" href=\"#URL#\">actualice</a> atributos de acceso creado previamente para las cotizaciones.";
...
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTR_DLG_SUMMARY_MSGVER_1"] = "Atributos de acceso ahora serán reconstruidos para todas las cotizaciones. Este procedimiento puede tardar algún tiempo.";
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTR_DLG_TITLE"] = "Actualizar Atributos de Acceso de las Cotizaciones";
$MESS["CRM_CONFIG_PERMS_REBUILD_QUOTE_ATTR_DLG_TITLE_MSGVER_1"] = "Actualizar Atributos de Acceso de las Cotizaciones";
