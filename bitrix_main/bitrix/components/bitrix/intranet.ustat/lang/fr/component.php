...
$MESS["INTRANET_USTAT_PERIOD_TITLE"] = "Plage de dates :";
$MESS["INTRANET_USTAT_SECTION_CRM_HELP_GENERAL"] = "Le nombre total d'actions dans le CRM (changements sur des affaires, des transactions, des prospects, etc) pour la période de temps sélectionnée.";
...
$MESS["INTRANET_USTAT_SECTION_DISK_HELP_GENERAL_MSGVER_1"] = "Nombre total de fichiers téléchargés ou modifiés dans Bitrix24 Drive pour une période de temps choisie.";
...
$MESS["INTRANET_USTAT_SECTION_DISK_HELP_INVOLVEMENT_MSGVER_1"] = "Pourcentage d'utilisateurs implémentant Bitrix24 Drive.";
