...
Não há nada complicado sobre o compartilhamento de arquivos - você pode até criar um arquivo na intranet e compartilhá-lo imediatamente. Para compartilhar um arquivo com os colegas para discussão, aprimoramento, ou apenas para sua informação, você pode começar apenas iniciando um novo post no Feed. Faça o upload do arquivo, ou criar um novo ( ver parte inferior direita na imagem abaixo).
...
Depois de editar o documento e salvar, o Feed criará um novo comentário que afirma que uma nova versão do documento foi criado por você. 
...
Se uma postagem ou mensagem de um colega está no Feed, você pode 'curti-la' usando o botão curtir naquela postagem. Curtir leva apenas um segundo, mas deixa a pessoa que escreveu saber que a contribuição foi valiosa para alguém e permite que os outros saibam que ela pode ser útil para eles.
...
Agora você pode obter atualizações, leia o Feed, comentar sobre as mensagens, receber notificações e responder aos colegas, não importa onde você está.
...
Em nossa intranet você pode compartilhar todas as informações relevantes para o trabalho. As mensagens podem ser enviadas a todos os funcionários, um grupo individual, ou para um único usuário. Os destinatários irão ver a sua mensagem no seu geral [I]Feed[/I].
...
Discutir soluções e detalhes da tarefa com seus colegas - basta adicionar um comentário a uma tarefa e ele será adicionado ao Feed - e outros podem reagir instantaneamente a ela. É muito mais fácil e mais rápido do que uma discussão por e-mail ou uma reunião demorada. Além disso, toda a história da tarefa estará sempre ao seu alcance: comentários e arquivos são armazenados na tarefa.
