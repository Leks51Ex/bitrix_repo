...
Dans le CRM, nous pouvons stocker des informations complètes sur nos clients - entreprises et les travailleurs, avec qui nous travaillons, ainsi que toute l'histoire de la coopération (transactions, de la correspondance, des informations sur les réunions) avec chacun de vos clients.
...
Par ailleurs, surtout pour ceux qui vont souvent aux réunions avec les clients, il existe une version mobile du CRM. En dehors du bureau, vous pouvez facilement mettre à jour l'ensemble des informations sur l'affaire en cours, fermer et même en créer un nouveau.

[IMG]https://www.bitrix24.fr/images/ustat/fr/crm9_1.png[/IMG] [IMG]https://www.bitrix24.fr/images/ustat/fr/crm9_2.png[/IMG]

[B]Evaluez votre travail avec le CRM[/B]

Utilisez le CRM si activement que possible. Pour suivre la façon dont vous avez maîtrisé ses possibilités, regardez le 'pouls de l'activité' et comparez vos résultats avec ceux de vos collègues.
...
Commençons à utiliser cet outil pratique : les contacts des clients, des magasins, des partenaires et contreparties avec lesquelles vous exécutez le CRM. Vérifions comment nous pouvons améliorer l'efficacité des ventes et le niveau de service à nos clients !
...
Maintenant tous les destinataires du message le verront dans le Activités Récentes et pourront afficher, télécharger ou même éditer le document directement dans la fenêtre de vue.

[IMG WIDTH=500 HEIGHT=562]https://www.bitrix24.com/images/ustat/en/disk2.png[/IMG]

[B] Comment modifier un document en ligne [/B]

Pour modifier les documents vous ne devez plus les enregistrer sur votre ordinateur utilisez pour cela les services de cloud : Google Docs ou MS Office Online. Vous pouvez choisir l'un d'eux après avoir cliquer sur le bouton 'Modifier'.

[IMG WIDTH=500 HEIGHT=331]https://www.bitrix24.com/images/ustat/en/disk3.png[/IMG]

Pour faire afficher et éditer un document vous devrez vous autoriser à votre compte Microsoft ou Google. Faites attention, dans le coin supérieur droit de la fenêtre il y a le bouton Entrée. Si vous n'avez pas de compte, vous pouvez facilement le créer. Cliquez sur le bouton Entrée et suivez le lien 'Enregistrer'. Tout est gratuit. 
Maintenant, vous pouvez éditer le texte et enregistrer les modifications.
...
C'est à vous de décider qui peut afficher ou éditer votre document, par exemple lorsque vous devez envoyer une présentation et donner un lien à quelqu'un de l'extérieur de l'entreprise. Si nécessaire vous pouvez donner accès à un employé particulier pour une période strictement définie, et aussi avec un accès par mot de passe.
...
$MESS["INTRANET_USTAT_TELLABOUT_IM_TITLE"] = "Communiquez avec plaisir !";
...
$MESS["INTRANET_USTAT_TELLABOUT_MOBILE_TEXT"] = "Chers amis ! Souvent nous devons travailler en dehors du bureau : sur le chemin vers le bureau, au cours des réunions avec les clients, pendant les vols, les voyages d'affaires. Il n'est pas très commode de prendre toujours et partout un ordinateur portable avec vous, tandis qu'il est important de rester tout le temps en contact avec ses collègues. Donc, je vous suggère d'utiliser l'application Bitrix24 Mobile qui peut être facilement installée sur votre smartphone ou tablette à partir de [url=https://itunes.apple.com/app/bitrix24/id561683423]Apple AppStore[/url] ou [url=https://play.google.com/store/apps/details?id=com.bitrix24.android]Google Play[/url].

[IMG]https://www.bitrix24.com/images/ustat/en/mob1.gif[/IMG]

Maintenant vous avez la possibilité de recevoir les informations de travail, de lire le Flux d'activités, de commenter les messages, d'être informé et de réagir rapidement, où que vous soyez.

[B]Contacts des collègues - toujours à portée de la main[/B]

La liste la plus complète et actuelle des contacts des collègues sera toujours à portée de la main. Dans la version mobile Bitrix24 il est aussi facile de trouver des informations sur l'employé en question que sur le portail.
...
[B]Contenu de l'application mobile ?[/B]

Dans l'application mobile vous avez l'accès à tous les outils principaux existants : 'Flux d'activités' avec les commentaires et J'aime, calendrier avec une liste des réunions, séances d'information et évènements pertinents, recherche et examen de documents. Malgré l'absence dans le bureau, vous serez au courant de toutes les affaires et continuerez à communiquer avec les collègues et à discuter des questions de travail en temps réel.
...
Vous pouvez surveiller la façon dont vous utilisez activement l'application mobile et comparez cela avec votre entreprise ou un service dans le Pulse de la société.
