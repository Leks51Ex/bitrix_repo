<?php
$MESS["BPCGWTL_CANT_DELETE"] = "Le modèle de processus d'entreprise ne peut pas être supprimé, puisqu'il y a déjà des processus d'entreprise lancés sous ce modèle.";
$MESS["BPCGWTL_EMPTY_TEMPLATE"] = "Le modèle de processus d’entreprise ayant pour code '#ID#' a un corps vide.";
...
$MESS["BPCGWTL_INVALID_WF_ID"] = "Le modèle du processus d’entreprise avec le code '#ID#' est introuvable.";
$MESS["BPCGWTL_UNKNOWN_ERROR"] = "Erreur inconnue.";
$MESS["BPCGWTL_WRONG_TEMPLATE"] = "Modèle du processus d'entreprise incorrect";
