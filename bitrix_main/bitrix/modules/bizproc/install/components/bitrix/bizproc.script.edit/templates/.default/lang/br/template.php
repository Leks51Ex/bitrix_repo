...
$MESS["BIZPROC_SCRIPT_EDIT_ROBOT_HELP"] = "Use regras de automação para simplificar o processo de gerenciamento de clientes e ajudar os funcionários a seguir um caminho aprovado de processamento de leads. As regras de automação executarão ações de maneira autônoma: enviar e-mails, fazer chamadas etc.";
