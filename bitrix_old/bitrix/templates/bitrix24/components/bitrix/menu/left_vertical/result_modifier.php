...
use Bitrix\Bizproc\Workflow\Entity;
...
if (Loader::includeModule('bizproc')) {
	$bpUserComments = \Bitrix\Bizproc\Workflow\Entity\WorkflowUserCommentTable::getCountUserUnread($USER->GetID());
	$counters["bp_tasks"] = $counters["bp_tasks"] - $bpUserComments;
}
